...
namespace AndreGoepel.AppFoundation.Tests.Components;

// Base context for the error-page component tests. Those components bootstrap
// their theme by calling the JS function "site.getInitialState" inside
